...
export const aboutMock = {
  ...
  name: "БУ РА «Республиканский реабилитационный центр для детей и подростков\nс ограниченными возможностями»",
  nameMobile:
    "БУ РА «Республиканский реабилитационный\nцентр для детей и подростков\nс ограниченными возможностями»",
  desc: "© 2023 БУ РА «РРЦ ДЛЯ ДЕТЕЙ И ПОДРОСТКОВ С ОГРАНИЧЕННЫМИ ВОЗМОЖНОСТЯМИ»",
  time: "8:00-17:00\nкроме Сб и Вс",
  place:
    "649002, Республика Алтай, г. Горно-Алтайск,\nпр. Коммунистический 109",
  placeCoordinates: [51.961767, 85.913095],
  phone: {
    number: 83882262301,
